...
struct Panel {
    ...
    mutating func addWire(_ wire: String, index: Int) {
...
var panel = Panel()
panel.addWire("R8,U5,L5,D3", index: 0)
panel.addWire("U7,R6,D4,L4", index: 1)
print(panel)
print(panel.field.extent())
panel.printField()
print(panel.nearestCrossingDistance())
